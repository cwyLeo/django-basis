...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(name="base", options={"managed": False},),
        migrations.AlterModelOptions(name="build", options={"managed": False},),
        migrations.AlterModelOptions(name="buy", options={"managed": False},),
        migrations.AlterModelOptions(name="car", options={"managed": False},),
        migrations.AlterModelOptions(name="customer", options={"managed": False},),
        migrations.AlterModelOptions(name="industry", options={"managed": False},),
        migrations.AlterModelOptions(name="sizes", options={"managed": False},),
    ]
